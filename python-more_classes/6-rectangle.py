...
class Rectangle:
    ...
    def __str__(self):
        ...
        Returns:
            str: El rectángulo representado como una cadena de
            caracteres con el carácter '#'.
    ...
    def __del__(self):
        """
        Imprime el mensaje "Bye rectangle..." cuando se eliminai
        una instancia de Rectangle.
